...
class SupportTicketController extends Controller
{
    ...
    public function pendingTicket()
    {
        ...
        $items = SupportTicket::whereIn('status', [Status::TICKET_OPEN,Status::TICKET_REPLY])->orderBy('id','desc')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
    ...
    public function closedTicket()
    {
        ...
        $items = SupportTicket::where('status',Status::TICKET_CLOSE)->orderBy('id','desc')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
    ...
    public function answeredTicket()
    {
        ...
        $items = SupportTicket::orderBy('id','desc')->where('status',Status::TICKET_ANSWER)->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
