...
class DepositController extends Controller
{
    ...
    protected function depositData($scope = null,$summery = false)
    {
        ...
        $deposits = $deposits->searchable(['trx','doctor:username'])->dateFilter();
    ...
    {
        $general = gs();
        $deposit = Deposit::where('id', $id)->with(['doctor', 'appointment', 'gateway'])->firstOrFail();
        $pageTitle =@$deposit->doctor->username.' Get Payment requested ' . showAmount($deposit->amount) . ' '.$general->cur_text;
    ...
    public function reject(Request $request)
    {
        ...
        notify($deposit->doctor, 'DEPOSIT_REJECT', [
