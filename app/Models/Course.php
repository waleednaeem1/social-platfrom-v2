...
class Course extends Model
{
    ...
    {
        return $this->hasMany(ShallowCourse::class, 'parent_course_id')->where('purchased_user_id', @auth()->user()->id)->select('id','parent_course_id','course_category_id','purchased_user_id','course_type_id','coach_id');
    }
