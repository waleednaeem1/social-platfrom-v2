                                    ...
                                    <div class="card-body">
                                        ...
                                        @csrf
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input type="text" class="form-control" id="cname" name="city" value="">
                                            </div>
                                            <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input  class="form-control" id="dob" name="date_of_birth" value="">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="form-label">Marital Status:</label>
                                                <input type="text" class="form-control" name="marital_status" id="marital_status" value="">
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <textarea class="form-control" name="address" rows="5" style="line-height: 22px;" value="">
                                                </textarea>
                                            </div>
                                        </div>
