                                            ...
                                            <div class=" row align-items-center">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="gender" id="inlineRadio10" value="male" checked="{{$users->gender == 'male'}}">
                                                        <label class="form-check-label" for="inlineRadio10"> Male</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="gender" id="inlineRadio11" value="female" checked="{{$users->gender == 'female'}}">
                                                        <label class="form-check-label" for="inlineRadio11">Female</label>
                                                    </div>
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label for="dob" class="form-label">Date Of Birth:</label>
                                                    <input  class="form-control" id="dob" name="date_of_birth" value="{{$users->date_of_birth}}">
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label class="form-label">Marital Status:</label>
                                                    <input type="text" class="form-control" name="marital_status" id="marital_status" value="{{$users->marital_status}}">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="age" id="age" value="{{$users->age}}">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="country" id="country" value="{{$users->country}}">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="state" id="state" value="{{$users->state}}">
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <textarea class="form-control" name="address" rows="5" style="line-height: 22px;">{{$users->address}}
                                                    </textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="cno" value="{{$users->phone_number}}">
                                            </div>
                                            <div class="form-group">
