                                    ...
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="profilePicPreview"
                                                style="background-image: url({{ getImage(getFilePath('maintenance') . '/' . @$maintenance->data_values->image, getFileSize('maintenance')) }})">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <small class="mt-2">@lang('Supported files'): <b>@lang('jpeg'),
                                                    @lang('jpg'). @lang('png').</b> @lang('Image will be resized into 700x400') </small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" data-width="100%" data-height="50"
                                                ...
                                                @if (@$general->maintenance_mode) checked @endif name="status">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
