                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload1" class="bg--primary">@lang('Logo For White Background')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload3" class="bg--primary">@lang('Select For Dark Background')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
