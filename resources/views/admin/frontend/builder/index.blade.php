        ...
        @if($pdata->id !== 1)
            <div class="col-md-7" style="margin-top:-10px">
                <div class="card">
                    ...
                    <div class="col-xl-11 mt-xl-0 mt-4">
                        <form action="{{route('admin.frontend.manage.section.meta.update',$pdata->id)}}" style="margin-left:20px" method="post">
                            @csrf
                            <div class="form-group">
                                <label>@lang('Meta Title')</label>
                                <input type="text" style="width: 100%;" class="form-control" name="meta_title" value="{{ @$pdata->meta_title }}" required/>
                            </div>
                            <div class="form-group">
                                <label>@lang('Meta Description')</label>
                                <textarea name="meta_description" style="width: 100%;" rows="3" class="form-control" required>{{ @$pdata->meta_description }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>@lang('Meta Keywords')</label>
                                <textarea name="meta_keywords" style="width: 100%;" rows="3" class="form-control" required>{{ @$pdata->meta_keywords }}</textarea>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn--primary w-100 h-45">@lang('Submit')</button>
                            </div>
