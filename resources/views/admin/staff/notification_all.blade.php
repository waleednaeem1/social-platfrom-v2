        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-3">
                    ...
                    <p>@lang('Email sent') <span class="sent">0</span> @lang('staffs out of') {{ $staffs }} @lang('staffs')</p>
        ...
        function postMail(form,skip){
            ...
            $.post("{{ route('admin.doctor.notification.all.send') }}", {
                ...
                if(response.error){
                    ...
                    var rest =  {{ $staffs }} - response.total_sent;
                    var sentPercent = response.total_sent / {{ $staffs }} * 100;
                    if (sentPercent > 100) {
                        sentPercent = 100;
                    }
                    ...
                    if(rest == 0){
                        setTimeout(() => {
                            ...
                            notify('success','Mail sent to all staffs successfully')
                        }, 3000);
                        return false;
                    }
                    setTimeout(()=>{
