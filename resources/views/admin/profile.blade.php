{{-- @php
    echo "<pre>";
    print_r($admin->avatar_location);
    print_r(getImage(getFilePath('adminProfile').'/'. $admin->avatar_location));
    die;
@endphp --}}
                ...
                <div class="card-body p-0">
                    <div class="d-flex p-3 bg--primary align-items-center">
                        <div class="avatar avatar--lg">
                            <img src="{{ getImage(getFilePath('adminProfile').'/'. $admin->avatar_location,getFileSize('adminProfile'))}}" alt="@lang('Image')">
                        </div>
                        <div class="ps-3">
                        ...
                        <div class="row">
                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview" style="background-image: url({{ getImage(getFilePath('adminProfile').'/'.$admin->avatar_location,getFileSize('adminProfile')) }})">
                            ...
                            <div class="col-xl-6 col-lg-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" name="email" value="{{ $admin->email }}" readonly required>
                                </div>
                            </div>
                        </div>
