...
<div class="row justify-content-center">
    @if(request()->routeIs('admin.deposit.list') || request()->routeIs('admin.deposit.method') ||  request()->routeIs('admin.users.deposits.method'))
                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <span class="small">
                                    <a href="{{ appendQuery('search',@$deposit->doctor->username) }}"><span>@</span>{{ @$deposit->doctor->username }}</a>
                                    </span>
                                </td>
                                <td>
