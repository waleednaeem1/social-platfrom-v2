                ...
                <button type="button" class="" data-bs-toggle="dropdown" data-display="static" aria-haspopup="true"
                    ...
                    <span class="navbar-user">
                        <span class="navbar-user__thumb"><img
                                ...
                                {{-- src="{{ getImage('assets/admin/images/profile/'. auth()->user()->avatar_location) }}" --}}
                                src="{{ getImage('storage/images/user/userProfileandCovers/'. auth()->user()->id . '/' . auth()->user()->avatar_location) }}"
                                {{-- "storage/images/user/userProfileandCovers/". $listing->id . '/' . $listing->avatar_location --}}
                                alt="image"></span>
