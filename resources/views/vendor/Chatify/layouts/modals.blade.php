  ...
  <div class="app-modal" data-name="settings">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              ...
              <form action="{{ route('imageCrop') }}" enctype="multipart/form-data" method="POST">
                  @csrf
                  ...
                  <div class="app-modal-body">
                      ...
                      @if(isset(Auth::user()->avatar_location) && Auth::user()->avatar_location !== '')
                            <img src="{{ asset('storage/images/user/userProfileandCovers/'. Auth::user()->id.'/'.Auth::user()->avatar_location) }}" alt="userimg" class="avatar av-l chatify-d-flex" style="margin-left: 9rem; margin-bottom:1rem" loading="lazy">
                        @else
