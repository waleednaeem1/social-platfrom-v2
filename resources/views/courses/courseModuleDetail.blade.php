               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="image-block position-relative">
                        {{-- <p class="mb-0">{{$data['module']->description}}</p> --}}
                        <p class="mb-0">{!! $data['module']->detail !!}</p>
                     </div>
                     @if(isset($data['module']->video_id) && $data['module']->video_id !== '')
                        <div class="image-block position-relative">
                           <iframe src="{{'https://player.vimeo.com/video/'.$data['module']->video_id}}" width="100%" height="500" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                        </div>
                     @endif
                  </div>
               </div>
