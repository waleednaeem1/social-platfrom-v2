																		...
																		<tr>
																			<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																				<a href="https://www.vtfriends.com"><img
                                                                                    src="{{ url('https://www.vtfriends.com/images/icon/logo.png') }}"  alt="" style="width:200px; margin-left: 55px; margin-top: 13px;"></a>
																			</td>
																		</tr>
																	</table>
																				...
																				<table width="100%" border="0" cellspacing="0" cellpadding="0">
																					<tr>
																						<td class="pb-50" style="padding-bottom: 50px;">
																							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 302px;">
																								<tr>
																									<td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
																										<a href="#" action="javascript:void();"><img src="{{ url('/assets/icons/img_intro_4.png') }}" width="368" height="296" border="0" alt="" /></a>
																									</td>
																								</tr>
																								<tr>
																								...
																								<tr>
																									<td class="text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; padding-bottom: 25px;">
																										We've received a Password Reset Request from your Account. OTP Code will be expired within 10 Minutes. After that, you'll have to ask for a new one.
                                                                                                        
                                                                                                        <p>If you do not wish to reset a password, no further action is required.</p>
                                                                                                    </td>
																								</tr>
																								<tr>
																									<td align="center">
																										<!-- Button -->
																										<table border="0" cellspacing="0" cellpadding="0" style="min-width: 280px;">
																											<tr>
																												<td class="btn-16 c-white l-white" bgcolor="#f3189e" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff; width: 2rem;
                                                                                                                padding: 1rem;">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="text-16 lh-26 a-center pb-25" style="padding-top: 20px; font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; padding-bottom: 25px;">
                                                                                                        Thank you. <br>

                                                                                                        Regards.<br>
                                                                                                        Devsinc Support Team
                                                                                                    </td>
                                                                                                </tr>
																							</table>
																						</td>
