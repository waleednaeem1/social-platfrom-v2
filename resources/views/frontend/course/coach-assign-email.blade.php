...
<head>
	...
	<!--<![endif]-->
	<title>Coach Assign Email</title>
	<!--[if gte mso 9]>
																	...
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
                                                                                <img src="{{ url('/assets/icons/img_intro_2.png') }}" width="284" height="280" border="0" alt="" />
                                                                            </td>
                                                                        </tr>
																		<tr>
																													...
																													<table width="100%" border="0" cellspacing="0" cellpadding="0">
																														<tr>
																															<td class="text-16" style="font-size:16px; line-height:20px; color:#272727; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important;">
																																Hi , Admin<br>
                                                                                                                                <br>
                                                                                                                                {{ Str::title($data['user']) }} wants to assign {{ Str::title($data['coach']->first_name.' '.$data['coach']->last_name) }}: {{Str::title($data['coach']->email) }} as his coach in {{ Str::title(str_replace('-', ' ', $data['courseSlug'])) }} course.
                                                                                                                                <br><br><br>
                                                                                                                                If you want to approve this action please click on the button given below.
																															</td>
																														</tr>
																													</table>
                                                                                                                    <table width="20%" border="0" cellspacing="5" cellpadding="5" style="margin-top: 20px;">
                                                                                                                        <tr>
                                                                                                                            <td class="btn-16 c-white l-white" bgcolor="#f3189e" style="    box-sizing: border-box;
                                                                                                                            font-size: 16px;
                                                                                                                            line-height: 20px;
                                                                                                                            ...
                                                                                                                            color: #ffffff;background-color: #f3189e;">
                                                                                                                                <a href="https://www.vtfriends.com/course/applyCoach/{{$data['courseSlug']}}/{{$data['coach']->id}}/{{auth()->user()->id}}" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;">
