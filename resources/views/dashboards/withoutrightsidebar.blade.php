<x-app-layout layout='withoutrightsidebar'>
<div class="container">
         <div class="row">
                  ...
                  <div class="card card-block card-stretch card-height">
                     <div class="card-body">
                        ...
                        <div class="user-post text-center">
                           <a href="javascript:void();"><img src="{{asset('images/page-img/p1.jpg')}}" alt="post-image" class="img-fluid profile-img"></a>
                        </div>
                        <div class="comment-area mt-3">
                           <div class="d-flex justify-content-between align-items-center">
                              <div class="like-block position-relative d-flex align-items-center">
                     ...
                     <div class="card-body">
                        <div class="user-post-data">
                           <div class="d-flex flex-wrap">
                              ...
                              <div class="media-support-info mt-2">
                                 ...
                                 <p class="mb-0 d-inline-block">Add New Video in his Timeline</p>
                        ...
                        <div class="user-post">
                           <div class="embed-responsive embed-responsive-16by9">
                              <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/zpOULjyy-n8?rel=0" allowfullscreen controls></iframe>
                           </div>
                        </div>
                        <div class="comment-area mt-3">
                           <div class="d-flex justify-content-between align-items-center">
